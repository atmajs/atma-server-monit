...
(function (LoggerFileHeader) {
    ...
    function serialize(opts) {
        ...
        let line = (_b = ((_a = opts.fields) !== null && _a !== void 0 ? _a : opts.columns)) === null || _b === void 0 ? void 0 : _b.map(field => {
...
class EmptyLoggerFile {
    ...
    writeRow(...args) {
        var _a;
        return (_a = this.channel) === null || _a === void 0 ? void 0 : _a.writeRow(...args);
    }
    write(...args) {
        var _a;
        return (_a = this.channel) === null || _a === void 0 ? void 0 : _a.write(...args);
    }
    flush() {
    ...
    removeAll() {
        var _a;
        return (_a = this.channel) === null || _a === void 0 ? void 0 : _a.removeAll();
    }
    pipe(channel) {
...
class LoggerFile {
    ...
    writeRow(cells, additional) {
        var _a, _b;
        let columns = (_a = this.opts.fields) !== null && _a !== void 0 ? _a : this.opts.columns;
        if (additional != null) {
            let arr;
            ...
            for (let i = 0; i < arr.length; i++) {
                ...
                if (colIndex === -1) {
                    colIndex = -1 + columns.push(Object.assign(Object.assign({}, col), { type: (_b = col.type) !== null && _b !== void 0 ? _b : csv_1.Csv.getTypeFromValue(col.value), value: void 0 }));
                }
                values[colIndex - count] = col.value;
            }
            cells.push(...values);
        }
        let row = LoggerFileRow_1.LoggerFileRow.serialize(cells, columns);
        this.write(row);
    }
    writeRows(cellsMany) {
    ...
    nextFile() {
        ...
        if (this.opts.addCsvHeader !== false) {
            let header = LoggerFileHeader_1.LoggerFileHeader.serialize(this.opts);
            if (header != null) {
                file.write(header);
            }
        }
...
class ChannelReader {
    ...
    getData(query) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let columns = (_b = channel.opts.fields) !== null && _b !== void 0 ? _b : channel.opts.columns;
            ...
            if (columns == null) {
                columns = (_e = rows === null || rows === void 0 ? void 0 : rows[0]) === null || _e === void 0 ? void 0 : _e.map((x, idx) => {
                    return {
                        idx: idx,
                        name: '',
                        type: 'string'
            ...
            let table = new Table_1.Table(columns, rows);
            return {
                columns: columns,
...
(function (Everlog) {
    ...
    function initialize(opts) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            $empty.splice(0).forEach(empty => {
                let channel = Everlog.monit.createChannel(empty.name, empty.opts);
                empty.pipe(channel);
            });
    ...
    function createChannel(name, opts) {
        if (Everlog.monit == null) {
            let empty = new LoggerFile_1.EmptyLoggerFile(name, opts);
            $empty.push(empty);
            return empty;
        }
        return Everlog.monit.createChannel(name, opts);
    }
...
(function (Monit) {
    ...
    function start(app, opts) {
        monit = new MonitWorker_1.MonitWorker(opts);
    ...
    function createChannel(name, opts) {
        var _a;
        return (_a = monit === null || monit === void 0 ? void 0 : monit.createChannel(name, opts)) !== null && _a !== void 0 ? _a : new LoggerFile_1.EmptyLoggerFile(name, opts);
    }
...
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
var Monit_1 = _src_Monit;
Object.defineProperty(exports, "Monit", { enumerable: true, get: function () { return Monit_1.Monit; } });
