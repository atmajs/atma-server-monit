...
const base = new atma_utils_1.class_Uri(`file://${__dirname}/`).cdUp();
class Server {
    constructor() {
        this.config = {
            user: null,
    ...
    run() {
        return __awaiter(this, void 0, void 0, function* () {
            const app = yield atma_server_1.Application.create({
                base: base.toString(),
                config: {
                    SERVER: true,
    ...
    init(app) {
        ...
        app
            ...
            middleware: [],
            after: [
                atma_server_1.middleware.static
            ]
        })
...
Object.defineProperty(exports, "__esModule", { value: true });
const AppCfg = _node_modules_appcfg_lib_appcfg;
